          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Agregar sucursal para <?php echo $name; ?>

                  <div class="card bg-secondary shadow border-0">
    <div class="card-body px-lg-5 py-lg-5">

        <form id="add-sucursal-form">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <input type="text" class="form-control" id="new-sucursal" name="new-sucursal" placeholder="Nueva Sucursal">
              </div>
            </div>

            <br><br><br><br>
            <div class="col-md-12" style="text-align:center;">
            <button class="btn btn-icon btn-sm btn-primary" type="button" id="save-new-sucursal-client">
                    <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                    <span class="btn-inner--text">Guardar sucursal</span>
            </button>
            </div>
        </form>
    </div>
...
<div class="card bg-secondary shadow border-0">
  ...
  $("#save-new-sucursal-client").click(function()
  {
    let newSucursal = $("#new-sucursal").val();
    ...
    else
    {
        ...
        $.post("Controller.php", {form: data, type: "add-sucursal"}, function(result)
        {
            if(result)
            {
