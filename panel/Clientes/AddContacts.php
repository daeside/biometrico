...
require_once ('../Cotizaciones/Controller.php');
require_once ('../DbHelper/Connection.php');
$id = $_GET['id'];
$name = $_GET['name'];
$sucursales = Connection::SelectAllDataOrderWhere("clientes_sucursales", "id", "ASC", $id);
?>
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Agregar contactos para <?php echo $name; ?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <input type="hidden" value="<?php echo $id; ?>" id="client-id" name="client-id">
              </div>
            ...
            <div class="col-md-12" id="detalle-container-1-1">
                <div class="form-group">
                  <input type="text" class="form-control form-client2" id="client-detalle-name-1" name="client-detalle-name-1" placeholder="Contacto nombre 1">
                </div>
              </div>
              <div class="col-md-6" id="detalle-container-2-1">
                <div class="form-group">
                  <input type="text" class="form-control form-client2" id="client-detalle-email-1" name="client-detalle-email-1" placeholder="Contacto correo 1">
                </div>
              </div>
              <div class="col-md-6" id="detalle-container-3-1">
                <div class="form-group">
                  <input type="text" class="form-control form-client2" id="client-detalle-tel-1" name="client-detalle-tel-1" placeholder="Contacto telefono 1">
                </div>
              </div>
            ...
            <br><br><br><br>
            <div class="col-md-12" style="text-align:center;">
            <button class="btn btn-icon btn-sm btn-primary" type="button" id="save-new-contacts">
                    <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                    <span class="btn-inner--text">Guardar contactos</span>
            </button>
            </div>
        </form>
    </div>
    ...
    <div class="card-body px-lg-5 py-lg-5">
        ...
        <form id="client-form">
          <div class="row">
            ...
            <br><br><br><br>
            <div class="col-md-12" style="text-align:center;">
            <button class="btn btn-icon btn-sm btn-primary" type="button" id="save-contacts">
                    <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
...
if(contador > 1)
{
  let data = "<div class='col-md-12' id='detalle-container-1-"+contador+"'><div class='form-group'><input type='text' class='form-control form-client2' id='client-detalle-name-"+contador+"' name='client-detalle-name-"+contador+"' placeholder='Contacto nombre "+contador+"'></div></div>";
  let data2 = "<div class='col-md-6' id='detalle-container-2-"+contador+"'><div class='form-group'><input type='text' class='form-control form-client2' id='client-detalle-email-"+contador+"' name='client-detalle-email-"+contador+"' placeholder='Contacto correo "+contador+"'></div></div>";
  let data3 = "<div class='col-md-6' id='detalle-container-3-"+contador+"'><div class='form-group'><input type='text' class='form-control form-client2' id='client-detalle-tel-"+contador+"' name='client-detalle-tel-"+contador+"' placeholder='Contacto telefono "+contador+"'></div></div>";
  $("#detalle-container-3-" + (contador - 1)).after(data+data2+data3);
  contador++; 
}
});

$("#remove-contacto-btn").click(function(){

if(contador > 2)
{
  $("#detalle-container-1-" + (contador - 1)).remove();
  $("#detalle-container-2-" + (contador - 1)).remove();
  $("#detalle-container-3-" + (contador - 1)).remove();
  contador--;
} 
});
  
  $("#save-new-contacts").click(function()
  {
    let products = true;
    let selectProducts = $(".form-client2");
    ...
    if(products)
 {
  let data = $("#add-contacts-form").serializeArray();

  $.post("Controller.php", {form: data, type: "save-contacts"}, function(result){
    if(result)
    {
      alert('Se guardaron los contactos correctamente');
      location.reload();
    }
    else
    {
