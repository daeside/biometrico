          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Lista de Clientes
                </div>
                <div class="col text-right">
                  
                <button class="btn btn-icon btn-sm btn-primary" type="button" data-toggle="modal" data-target="#nuevo-cliente">
...
/*
$("#add-sucursal-btn").click(function(){

  if(contador > 1)
  {
    let data = "<br id='client-br-" + contador + "'><input type='text' class='form-control form-client' id='client-sucursal-"+contador+"' name='client-sucursal-"+contador+"' placeholder='Sucursal "+contador+"'>";
    $("#client-sucursal-" + (contador - 1)).after(data);
    contador++; 
  }
});

$("#remove-sucursal-btn").click(function(){

  if(contador > 2)
  {
    $("#client-sucursal-" + (contador - 1)).remove();
    $("#client-br-" + (contador - 1)).remove();
    contador--;
  } 
});
*/
...
if(contador > 1)
{
  let data = "<div class='col-md-12' id='detalle-container-1-"+contador+"'><div class='form-group'><input type='text' class='form-control form-client' id='client-detalle-name-"+contador+"' name='client-detalle-name-"+contador+"' placeholder='Contacto nombre "+contador+"'></div></div>";
  let data2 = "<div class='col-md-6' id='detalle-container-2-"+contador+"'><div class='form-group'><input type='text' class='form-control form-client' id='client-detalle-email-"+contador+"' name='client-detalle-email-"+contador+"' placeholder='Contacto correo "+contador+"'></div></div>";
  let data3 = "<div class='col-md-6' id='detalle-container-3-"+contador+"'><div class='form-group'><input type='text' class='form-control form-client' id='client-detalle-tel-"+contador+"' name='client-detalle-tel-"+contador+"' placeholder='Contacto telefono "+contador+"'></div></div>";
...
if(contador > 2)
{
  ...
  {
    let products = true;
    let selectProducts = $(".form-client");
