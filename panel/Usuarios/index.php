...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Usuarios</a>
        <!-- Form -->
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control form-user" id="user-name" name="user-name" placeholder="Nombre">
              </div>
            </div>

            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control form-user" id="user-last-name" name="user-last-name" placeholder="Apellido">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="email" class="form-control form-user" id="user-mail" name="user-mail" placeholder="Correo">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control form-user" id="user-tel" name="user-tel" placeholder="Telefono">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control form-user" id="user-pass" name="user-pass" placeholder="Contraseña">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control form-user" id="user-pass-2" name="user-pass-2" placeholder="Confirmar contraseña">
              </div>
            </div>

            <br><br><br>
            <div class="col-md-12" style="text-align:center;">
            <button class="btn btn-icon btn-sm btn-primary" type="button" id="save-user">
                    <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                    <span class="btn-inner--text">Guardar usuario</span>
            </button>
            </div>
        </form>
...
$(document).ready(function() {
  ...
  {
    let products = true;
    let selectProducts = $(".form-user");
    let passEquals = $("#user-pass").val() === $("#user-pass-2").val();
